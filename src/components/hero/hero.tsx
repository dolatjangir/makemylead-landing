    ...
    <div>
         {/* Hero Section */}
            <section className="relative mt-12 pt-28 pb-20 lg:pt-24 lg:pb-32 overflow-hidden">
              <div className="absolute inset-0 bg-[url('/assets/mobile-screen-hero-image.png')] sm:bg-[url('/assets/makemylead-hero.webp')] bg-center bg-cover lg:h-screen after:bg-slate-900/10 after:absolute after:top-0 after:left-0 after:w-full after:h-full bg-no-repeat " />
